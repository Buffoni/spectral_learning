...
class Autoencoder(Model):
  def __init__(self, latent_dim):
    ...
    self.encoder = tf.keras.Sequential([
      layers.Flatten(),
      layers.Dense(latent_dim, activation='tanh',kernel_regularizer=tf.keras.regularizers.l1(l1=0.0005)),
    ])
...
accuracy_perc_plot.get_figure().savefig("./test/mnist_enc_tanh.png")
plt.show()
